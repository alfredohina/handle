...
class OLDAddCont extends Component {
    render() {
        return (<div style={{width:"70%", display:"block", margin:"auto", textAlign:"center", marginTop:"30px"}}>
...
<div className="field is-horizontal">
  ...
  <div className="field-body">
    <div className="field">
      ...
      <p cclassNamelass="help is-danger">
